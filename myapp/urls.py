...
urlpatterns = [
    ...
    path('saller_edit_profile/',views.saller_edit_profile,name='saller_edit_profile'),
    path('saller_change_password/',views.saller_change_password,name='saller_change_password'),
